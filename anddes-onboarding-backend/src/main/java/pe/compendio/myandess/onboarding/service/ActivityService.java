...
public class ActivityService {
    ...
    public List<ELearningContent> listELearningContent() {
        return (List<ELearningContent>) eLearningContentRepository.findAll();
    }
    ...
    public void updateELearningContent(ELearningContent eLearningContent) {
        ...
        if (optional.isPresent()) {
            ...
            content.setName(eLearningContent.getName());
            content.setPassingScore(eLearningContent.getPassingScore());
            content.setImage(eLearningContent.getImage());
            eLearningContentRepository.save(content);
